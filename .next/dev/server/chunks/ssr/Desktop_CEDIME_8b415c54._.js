...
function RequestsPage() {
    const { addRequest } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$CEDIME$2f$lib$2f$data$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useData"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$CEDIME$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
    ...
    const handleWizardSubmit = (requests)=>{
        // Criar uma requisição para cada instituição
        requests.forEach((requestData)=>{
            addRequest(requestData);
        });
        toast({
            title: 'Requisições criadas',
            description: `${requests.length} requisição(ões) criada(s) com sucesso.`
        });
    };
...
//# sourceMappingURL=Desktop_CEDIME_8b415c54._.js.map